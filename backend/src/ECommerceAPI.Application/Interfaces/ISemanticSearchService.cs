// FILE: ECommerceAPI.Application/Interfaces/ISemanticSearchService.cs
...
namespace ECommerceAPI.Application.Interfaces
{
    ...
    public interface ISemanticSearchService
    {
        Task<SemanticSearchResponseDto> SearchAsync(
            string  query,
            int     topK     = 5,
            double? minPrice = null,   // filter results >= minPrice
            double? maxPrice = null);  // filter results <= maxPrice
    }
}